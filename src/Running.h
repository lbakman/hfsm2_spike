...
*                                                               *
****************************************************************/
#ifndef HFSM2SPIKE_RUNNING_H
#define HFSM2SPIKE_RUNNING_H

#include "MachineDeclaration.h"

struct Running : public HFSM::State
{
	Running() = default;
	~Running() = default;
	void enter(Control&);
	void react(const action_stop&, FullControl&);
	using HFSM::State::react;
};

#endif //HFSM2SPIKE_RUNNING_H
